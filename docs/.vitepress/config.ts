      ...
      '/components/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Mass Marks', link: '/components/mass-marks' },
            { text: 'District Layer', link: '/components/district-layer' },
            { text: 'GeoJSON Layer', link: '/components/geojson-layer' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Mouse Tool', link: '/components/mouse-tool' },
            ...
            { text: 'Reverse Geocode Panel', link: '/components/reverse-geocode-panel' },
            { text: 'Auto Complete', link: '/components/auto-complete' },
            { text: 'Place Search', link: '/components/place-search' },
            { text: 'Driving', link: '/components/driving' },
            { text: 'Walking', link: '/components/walking' },
            { text: 'Riding', link: '/components/riding' },
            { text: 'Weather Panel', link: '/components/weather-panel' },
          ],
        },
      ],
      '/hooks/': [
        {
          ...
          items: [
            ...
            { text: 'useGeocoder', link: '/hooks/use-geocoder' },
            { text: 'useAutoComplete', link: '/hooks/use-auto-complete' },
            { text: 'useGeolocation', link: '/hooks/use-geolocation' },
            { text: 'useWeather', link: '/hooks/use-weather' },
            { text: 'usePlaceSearch', link: '/hooks/use-place-search' },
            { text: 'useDriving', link: '/hooks/use-driving' },
            { text: 'useWalking', link: '/hooks/use-walking' },
            { text: 'useRiding', link: '/hooks/use-riding' },
