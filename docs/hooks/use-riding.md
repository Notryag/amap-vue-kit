...
| --- | --- | --- |
| ...`AMap.Riding.Options` | `Partial<AMap.Riding.Options>` | Native riding options such as `policy`, `hideMarkers`, etc. |
...
- Supply a custom `panel` element via `AMap.Riding.Options` if you want result summaries.
